...
import 'package:sell_books_web/omise_unitl/res/TokenOmise.dart';

class TokenResourceOmise extends ResourceOmise {
  final String host = "vault.omise.co";
  TokenResourceOmise(ClientOmise client, String publicKey, String apiVersion)

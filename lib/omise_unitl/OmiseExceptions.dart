...
abstract class OmiseExceptions implements Exception {
  final String code;
  final String message;

  OmiseExceptions(this.code, this.message);
}

/// Invalid request errors arise when your request has invalid parameters.
class InvalidRequestException extends OmiseExceptions {
...
class UnknownTypeException extends OmiseExceptions {
...
/// Invalid resource.
class InvalidResourceException extends OmiseExceptions {
...
class InvalidSignatureException extends OmiseExceptions {
